    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.action_settings:
                CustomToast.show(getApplicationContext(),"Settings are all ok!");
                break;

            case R.id.graphics:
                CustomToast.show(getApplicationContext(),"Graphics");
                break;
            case R.id.developer:
                CustomToast.show(getApplicationContext(),"Kush");
                break;
            case R.id.contact:
                CustomToast.show(getApplicationContext(),"prodologyhackathon@gmail.com");
                break;
